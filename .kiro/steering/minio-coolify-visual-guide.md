...
Value:         REDACTED_EXAMPLE_PASSWORD_001
[Save]
```
...
│ MINIO_ROOT_PASSWORD  │ REDACTED_EXAMPLE_PASSWORD_001           │
...
│ AWS_SECRET_ACCESS_KEY       │ REDACTED_EXAMPLE_PASSWORD_001     │
...
| 2 | MINIO_ROOT_PASSWORD | REDACTED_EXAMPLE_PASSWORD_001 |
| 3 | MINIO_PUBLIC_URL | http://76.13.193.161:9000 |
| 4 | AWS_ACCESS_KEY_ID | minioadmin |
| 5 | AWS_SECRET_ACCESS_KEY | REDACTED_EXAMPLE_PASSWORD_001 |
...
- **Ganti password** `REDACTED_EXAMPLE_PASSWORD_001` dengan password yang lebih kuat
