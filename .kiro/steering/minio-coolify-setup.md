...
MINIO_ROOT_PASSWORD=YourREDACTED_EXAMPLE_PASSWORD_001
...
AWS_SECRET_ACCESS_KEY=YourREDACTED_EXAMPLE_PASSWORD_001
...
2. Login dengan:
   - Username: `minioadmin`
   - Password: `YourREDACTED_EXAMPLE_PASSWORD_001`
...
- Ganti `YourREDACTED_EXAMPLE_PASSWORD_001` dengan password yang kuat
