...
- [x] 5. Preservation Testing — Verifikasi perilaku yang tidak berubah
  - [x] 5.1 Tulis preservation test untuk pengajuan individual
    - Tambahkan test di `backend/tests/Unit/SkDocumentNotificationTest.php`
  ...
  - [x] 5.2 Tulis preservation test untuk jalur queue bulk (>3 dokumen)
    - Tambahkan test di `backend/tests/Unit/SkDocumentNotificationTest.php`
  ...
  - [x] 5.3 Tulis preservation test untuk notifikasi dengan created_by valid
    - Tambahkan test di `backend/tests/Unit/SkDocumentNotificationTest.php`
  ...
  - [x] 5.4 Tulis preservation test untuk polling dan badge display
    - Tambahkan test di `src/components/common/NotificationDropdown.test.tsx`
...
- [x] 6. Checkpoint — Jalankan semua test dan verifikasi
  - [x] 6.1 Jalankan backend unit tests
  ...
  - [x] 6.3 Verifikasi manual di browser (opsional)
