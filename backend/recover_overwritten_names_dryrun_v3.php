...
echo "=== [DRY RUN - KUNCIAN TANGGAL 4 JULI] MEMULIHKAN NAMA SK YANG TERTUKAR ===\n";
...
// Lacak SK mana saja yang sudah disimulasikan
$processedSkIds = [];
    ...
    if (isset($props['old']['nama']) && isset($props['new']['nama'])) {
        ...
        if ($oldName !== $newName) {
            ...
            if ($isCompletelyDifferent) {
                ...
                // Cek jika nama saat ini memang masih melenceng
...
echo "Total perubahan wajar (tambah gelar/typo) yang AKAN DIBIARKAN: {$skippedCount}\n";
