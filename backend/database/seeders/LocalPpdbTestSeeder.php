...
/**
 * Seeder data simulasi PPDB khusus untuk lingkungan Local Development / Testing.
 * Digunakan untuk menguji fitur pencarian (fitur ketik), filter jenjang, dan pendaftaran online.
 */
class LocalPpdbTestSeeder extends Seeder
{
    public function run(): void
    {
        if (!app()->environment('local', 'testing')) {
            $this->command->warn('LocalPpdbTestSeeder hanya diizinkan berjalan pada environment local atau testing.');
            return;
        }
        ...
        // Buat gelombang serentak aktif (school_id = null)
        ...
        $this->command->info('LocalPpdbTestSeeder: 12 data simulasi madrasah & 1 gelombang PPDB serentak berhasil dibuat.');
    }
}
