...
import { JenjangStats } from '@/services/dashboardApi';
...
export function JenjangCard({ data, total }: JenjangCardProps) {
  ...
  const categories = [
    ...
    },
    {
      label: 'MTs / SMP',
      count: data.mts_smp,
      percentage: calculatePercentage(data.mts_smp),
    },
    {
      label: 'MA / SMA / SMK',
      count: data.ma_sma_smk,
      percentage: calculatePercentage(data.ma_sma_smk),
    },
    {
      label: 'Lainnya',
      count: data.lainnya,
      percentage: calculatePercentage(data.lainnya),
    },
    {
